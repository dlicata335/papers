...
\newcommand{\wfdiaglob}[2]{\ensuremath{{#1} \vdash {#2} \: \dsd{diaglob}}}
...
\newcommand{\wfglob}[3]{\ensuremath{{#1} \vdash {#2} \: \dsd{glob}_{#3}}}
...
\newcommand{\fsttelglob}[3]{\dsd{Rdc}_{#1}^{#2}(#3)}
\newcommand{\sndtelglob}[3]{\dsd{Rac}_{#1}^{#2}(#3)}
\newcommand{\teltm}[2]{\ensuremath{\tel{#1}\, {:}\, \tel{#2}}}

\newcommand{\wfdepglob}[4]%
  {\ensuremath{{#1} \vdash {#2} \: \dsd{depglob}^{#3}_{#4}}}
