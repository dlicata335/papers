% Change to "0 = 1" if you want to see all the n and m
\ifthenelse{0 = 0}{
...
\newcommand{\wftype}[2]{\ensuremath{\ctx{#1} \vdash \dcd{#2} \: \dsd{type}}}
\newcommand{\wfglob}[4]{
  \ensuremath{\ctx{#1} \vdash \dcd{#2} \: \dsd{glob}^{#3}_{\dcd{#4}}}}
\newcommand{\wfdepglob}[4]{
  \ensuremath{\ctx{#1} \vdash \dcd{#2} \: \dsd{depglob}^{#3}_{\dcd{#4}}}}
\newcommand{\ofglob}[3]{\ensuremath{\ctx{#1} \vdash \dcd{#2} : {#3}}}
...
\newcommand{\wfdiag}[1]{\ensuremath{\vdash\ctx{#1} \: \dsd{diag}}}
...
\newcommand{\wfctx}[1]{\ensuremath{\vdash\ctx{#1} \: \dsd{ctx}}}
