...
\newcommand{\wfdiaglob}[2]{
  \ensuremath{{#1} \vdash {#2} \: \dsd{diaglob}}}
...
\newcommand{\wfglob}[3]{
  \ensuremath{{#1} \vdash {#2} \: \dsd{glob}_{#3}}}
\newcommand{\ofglob}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}

\newcommand{\wftel}[2]{
  \ensuremath{{#1} \vdash {#2} \: \dsd{tel}}}
...
\newcommand{\depcoh}[4]{\ensuremath{\dsd{depcoh}_{#1} \dcd{({#2};{#3},{#4})}}}
\newcommand{\diagcoh}[2]{\ensuremath{\dsd{\diag{coh}}_{#1}(\dcd{#2})}}
