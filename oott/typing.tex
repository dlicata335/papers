...
\FIXME{Switch $\Psi$ to $\vec{A}$.}

\FIXME{Switch $\delta_0,\delta$ to $\delta,\eta$.}

\FIXME{Switch $M,N$ to $M_1,M_2$ and dependent ($u,v$) to $N_1,N_2$.}
...
\FIXME{New definition: $\wfglob{\Gamma}{G}{A} :=
\wfdepglob{\Gamma}{G}{\emptyctx.A}{\emptyctx}$}

\FIXME{New definition: $\ofglob{\Gamma}{M}{G} :=
\ofdepglob{\Gamma}{M}{G}{()}$}
