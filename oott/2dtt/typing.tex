...
We have meta-operations $\interpdiag{\diag\Gamma}{A}$ and $\interpdiag{\diag
G}{A}$ of the following types:
\begin{small}
\[
...
&\\
\interpdiaglob{\diagbase}{A} &:= A \\
\interpdiaglob{\iid{\diag G}{x}{y}}{A} &:= \iid{\interpdiaglob{\diag G}{A}}{x}{y} \\
\end{aligned}\]
\end{small}
