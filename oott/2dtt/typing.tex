...
\iidover{x.\picl{y}{B}{C}}{\tptm{\alpha}{\iid{}{M_1}{M_2}}}{N_1}{N_2} & \mapsto & \picl{y_1}{\subst{A}{M_1}{x}}{\subst{A}{M_2}{x}}{\picl{y_2}{\subst{A}{M_2}{x}}{\picl{p}{\iidover{x.B}{\alpha}{y_1}{y_2}}{\iidover{(x,y).C}{(\alpha,p)}{N_1}{N_2}}}} \\
...
\iidover{x.\neu{A}}{\alpha}{N_1}{N_2} & \mapsto & \iid{}{\transport{x.G\ep}{\alpha}{N_1}}{N_2} \\\end{array}
\]
\end{small}
