...
{\deduce{#4}{#3}}}
\newcommand{\inferthree}[5][]{\infer[#1]{#2}%
{\deduce{\deduce{#5}{#4}}{#3}}}
\newcommand{\inferfour}[6][]{\infer[#1]{#2}%
{\deduce{\deduce{\deduce{#6}{#5}}{#4}}{#3}}}

\newcommand{\emptyctx}{\ensuremath{\varnothing}}
\newcommand{\emptytel}{\ensuremath{\varnothing}}
\newcommand{\unitglob}[1]{\ensuremath{\mathbf{1}_{#1}}}
\newcommand{\unitglobelt}[1]{\ensuremath{\mathbf{\star}_{#1}}}
\newcommand{\blank}{\square}

% diagram calculus
\newcommand{\diag}[1]{\ensuremath{\overline{#1}}}
\newcommand{\wfdiag}[1]{\ensuremath{#1 \: \dsd{diag}}}
\newcommand{\wfdiagctx}[1]{\ensuremath{{#1} \: \dsd{diagctx}}}
\newcommand{\wfdiagtp}[2]{\ensuremath{{#1} \vdash {#2} \: \dsd{diagtype}}}
\newcommand{\ofdiagtp}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}
\newcommand{\substdiagtp}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}

\newcommand{\wfdiaglob}[3]{\ensuremath{{#1} \vdash {#2} \: \dsd{diaglob}_{#3}}}
\newcommand{\ofdiaglob}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}
\newcommand{\substdiaglob}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}
\newcommand{\diagbase}{\ensuremath{\mathord{*}}}
...
\newcommand{\wfglob}[4]{\ensuremath{{#1} \vdash {#2} \: \tel{\dsd{glob}}^{#3}_{#4}}}
\newcommand{\ofglob}[3]{\ensuremath{{#1} \vdash {#2} : {#3}}}

\newcommand\homj[3]{\ensuremath{#2 =^{#1} #3}}
\newcommand\dhomj[4]{\ensuremath{#2 =^{#1}_{#4} #3}}

\newcommand{\interpdiag}[2]{\ensuremath{[ #1 ]_{#2}}}
\newcommand{\interpdiaglob}[2]{[{#1}]_{#2}}

\newcommand{\ofinterp}[4]{\ofglob{#1}{#2}{\interpdiag{#3}{#4}}}
\newcommand{\interpglob}[3]{[{#1}]_{#2}^{#3}}

\newcommand{\interpdiagdep}[2]{\ensuremath{\langle #1 \rangle_{#2}}}
\newcommand{\ofinterpdep}[5]{\ofdepglob{#1}{#2}{\interpdiagdep{#3}{#4}}{#5}}
\newcommand{\interpdepglob}[3]{\langle {#1}\rangle_{#2}^{#3}}

\newcommand{\tel}[1]{\ensuremath{\overrightarrow{#1}}}
\newcommand{\wftel}[2]{\ensuremath{{#1} \vdash {#2} \: \dsd{tel}}}
\newcommand{\teltm}[2]{\ensuremath{\tel{#1}\, {:}\, \tel{#2}}}

\newcommand{\lhs}[1]{\tel{\dsd{LHS}}(#1)}
\newcommand{\rhs}[1]{\tel{\dsd{RHS}}(#1)}
\newcommand{\mhs}[1]{\tel{\dsd{MHS}}(#1)}

\newcommand{\fstinterp}[1]{\dsd{[fst]}(#1)}
\newcommand{\sndinterp}[1]{\dsd{[snd]}(#1)}
\newcommand{\Fstsigma}[2]{\dsd{Fst}(#1,#2)}
\newcommand{\Sndsigma}[2]{\dsd{Snd}(#1,#2)}
\newcommand{\mapfst}[1]{\app{\dsd{mapfst}}{#1}}
\newcommand{\mapsnd}[1]{\app{\dsd{mapsnd}}{#1}}

\newcommand{\Ev}[2]{\dsd{Ev}(#1,#2)}
\newcommand{\ev}[2]{\dsd{ev}(#1,#2)}

\newcommand{\deqdepglob}[5]{\ensuremath{#1 \vdash #2\mathbin{\downarrow}#3%
\, \equiv \, #4\mathbin{\downarrow}#5}}
\newcommand{\wfdepglob}[4]%
  {\ensuremath{{#1} \vdash {#2} \: \dsd{glob}^{#3}_{#4}}}
\newcommand{\ofdepglob}[4]%
  {\ensuremath{{#1} \vdash {#2} : {#3}\mathbin{\downarrow}{#4}}}

\newcommand{\Ap}[2]{\ensuremath{\dsd{Ap} \: {#1} \: {#2}}}
\newcommand{\ap}[2]{\ensuremath{\dsd{ap} \: {#1} \: {#2}}}

\newcommand{\coh}[3]{\ensuremath{\dsd{coh}_{#1} ({#2};{#3})}}
\newcommand{\depcoh}[3]{\ensuremath{\dsd{depcoh}_{#1} ({#2};{#3})}}
\newcommand{\diagcoh}[2]{\ensuremath{\dsd{\diag{coh}}_{#1}(#2)}}

\newcommand{\unit}{\dsd{1}}
\newcommand{\mt}{\dsd{\langle\rangle}}
\newcommand{\unitind}[2]{\dsd{ind}_{\unit}(#1,#2)}

\newcommand{\inl}[1]{\app{\dsd{inl}}{#1}}
\newcommand{\inr}[1]{\app{\dsd{inr}}{#1}}
\newcommand{\smind}[4]{\dsd{ind}_{#1}(#2,#3,#4)}
...
\newcommand{\sind}[3]{\dsd{ind}_{\sone}(#1,#2,#3)}
...
\newcommand\transportinv[3]{\ensuremath{\dsd{transport}_{#1}^\dsd{-1} \ #2 \ #3}}
...
\newcommand\iid[3]{\ensuremath{#2 =^{#1} #3}} %% infix identity type
\newcommand\iidover[4]{\ensuremath{#3 =^{#1}_{#2} #4}}

\newcommand\subst[3]{\ensuremath{#1 [ #2 / #3]}}

\newcommand{\deqofdepglob}[5]{\ensuremath{#1\,\vdash\,#2 \, \equiv \, #3 \, : #4
\downarrow #5}}
\newcommand{\deqtype}[3]{\ensuremath{#1\,\vdash\,#2 \, \equiv \, #3 : \typ i}}
...
% term : type
\newcommand{\tptm}[2]{\ensuremath{#1 \, {:} \, #2}}
\newcommand{\tptmns}[2]{\ensuremath{#1 {:} #2}}
...
\newcommand{\picd}[2]{\ensuremath{\appp{\textnormal{$\Pi$}}{#1}{#2}}}
\newcommand{\sigmacd}[2]{\ensuremath{\appp{\textnormal{$\Sigma$}}{#1}{#2}}}
\newcommand{\unitcd}[0]{\ensuremath{\dsd{unit}}}
\newcommand{\smcd}[2]{\ensuremath{#1 + #2}}
\newcommand{\idcd}[3]{\ensuremath{\dsd{Id}_#1 \: #2 \: #3}}
...
\newcommand{\deqtm}[4]{\ensuremath{#1\,\vdash\,\dcd{#2} \, \equiv \, \dcd{#3} \, \dcd{:} \, #4}}

%types
\newcommand{\deqtp}[3]{\ensuremath{#1\,\vdash\, {#2} \, \equiv \, {#3} \, \dsd{type}}}
